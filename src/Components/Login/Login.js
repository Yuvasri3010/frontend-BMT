...
const Login = () => {
  ...
  return (
    <div
      className="d-flex flex-wrap justify-content-center justify-between align-items-center"
      style={{ height: "90vh", marginRight: "18px" }}>
      <div
        className="leftArea bg-black text-primary text-start   "
        style={{ width: "300px", height: "380px", marginRight: "28px" }}>
        <div>
          <img
            src={login}
            alt=""
      ...
      <div
        ...
        style={{}}>
        <form
          className="text-start border  shadow p-3 "
